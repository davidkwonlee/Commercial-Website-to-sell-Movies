...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (requestURI.endsWith("_dashboard.html")) {
        ...
        if (httpRequest.getSession().getAttribute("user") == null && httpRequest.getSession().getAttribute("employee") == null) {
        	System.out.println("this is whats happening");
    ...
    private boolean isUrlAllowedWithoutLogin(String requestURI) {
        ...
        return requestURI.endsWith("login.html") || requestURI.endsWith("login.js")
                || requestURI.endsWith("api/login") || requestURI.endsWith("_dashboard-login.html") || requestURI.endsWith("logindashboard.js") || requestURI.endsWith("api/dashboardlogin") || requestURI.endsWith("api/android-login");
    }
